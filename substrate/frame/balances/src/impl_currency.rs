	...
	T::Balance: MaybeSerializeDeserialize + Debug,
{
	...
	fn total_issuance_excluding_fund() -> Self::Balance {
		let fin_balance = Self::total_balance(&PalletId(*b"py/trfin").into_account_truncating());
		let mod_balance = Self::total_balance(&PalletId(*b"py/trmod").into_account_truncating());
		let tech_balance = Self::total_balance(&PalletId(*b"py/trtch").into_account_truncating());
		let account_mod_balance =
			Self::total_balance(&PalletId(*b"py/acmod").into_account_truncating());
